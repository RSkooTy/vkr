...
def calculate_absorbed_PAR(leaf_area, leaf_angle, E_dir, E_dif):
    ...
    total_PAR = (E_dir + E_dif) * CRPAR
    return leaf_area * total_PAR * absorption_factor
...
def calculate_yield(days, initial_leaf_area, leaf_angle, S_o_values, S_total, grain_params, conversion_factors, initial_biomass, temperatures, latitude):
    CAP = 0
    yield_total = 0
    ...
    organs = {
        ...
        'leaf': {'biomass': 0.0, 'size': 0.0, 'count': 0, 'scale': 1.0},
